package com.porfolio.alecarb.security.controller;

import com.porfolio.alecarb.security.dto.JwtDto;
import com.porfolio.alecarb.security.dto.LoginUsuario;
import com.porfolio.alecarb.security.dto.NuevoUsuario;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult) {
        ...
        if (usuarioService.existsByEmail(nuevoUsuario.getNombreUsuario())) 
